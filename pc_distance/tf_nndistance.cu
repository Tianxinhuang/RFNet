...
//void init_idx(int b, int n, int* remained_idx){
//        for(int i=blockIdx.x;i<b;i+=gridDim.x)
//        {
//                for (int j=threadIdx.x;j<n;j+=blockDim.x)
//                {
//                        remained_idx[j+i*n]=j;
//                }
//        }
//}
//result_i:batch*npoint2
//remained_idx:batch*npoint1
//npoint1>npoint2
//void ModelSubKernel(int b,int n, const float * xyz,int m,int * result_i,int * remained_idx)
//{
//        
//
//}
...
//remained_idx:batch*npoint1
//xyz2:batch*npoint2
//npoint1>npoint2,we want remain ids after xyz-xyz2
//void modelsubstractLauncher(int b,int n,const float * xyz,int m,const float * xyz2,float * result,int * result_i,int * remained_idx,float eps, int iters)
//{
//        init_idx<<<b,512>>>(b,n,remained_idx);
//        for (int i=0;i<iters;i++)
//        {
//                NmDistanceKernel<<<dim3(32,16,1),512>>>(b,n,xyz2,m,xyz,result,result_i);
//                //ModelSubKernel<<<dim3(32,16,1),512>>>(b,n,xyz,m,result_i,remained_idx);
//                if (result_i>eps)
//                {
//                        break;
//                }
